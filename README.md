...
```bash
bash <(wget -qO- https://raw.githubusercontent.com/Rawtech7/senharoot/main/senharoot.sh)
```
...
```bash
apt update -y && apt upgrade -y && wget -y; bash <(wget -qO- raw.githubusercontent.com/Rawtech7/SSHPLUS/main/ssh-plus)
```

# ########################################################################################################################

# 🎮 BOT WHATSAPP DE VENDAS SSH ![image](https://github.com/Rawtech7/SSHPLUS/assets/101994539/18f9664c-458e-4a0f-a27b-96e64587cba0)
...
```bash
sudo apt install curl -y; bash <(curl https://raw.githubusercontent.com/Rawtech7/WaBot-VendasSSH/main/install.sh)
```
### • Parte 2
